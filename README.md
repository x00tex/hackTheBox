...
**Last update:** [Mailroom](Boxes/linux/Retired/mailroom/README.md)

## :penguin:*nix


<!-- |<a href="https://app.hackthebox.eu/machines/name"><img width="25" hight="25" alt="name" src="assets/name.png"></a>|$\textcolor{green}{\textsf{Easy}}$|[Name](Boxes/linux/Retired/name/README.md)|[](Boxes/linux/Retired/name/README.md)|[](Boxes/linux/Retired/name/README.md)| -->


|Box|Difficulty|Writeup|Foothold|Privesc|
|---|----------|-------|--------|-------|
|<a href="https://app.hackthebox.eu/machines/Agile"><img width="25" hight="25" alt="agile" src="assets/agile.png"></a>|$\textcolor{orange}{\textsf{Medium}}$|[Agile](Boxes/linux/Retired/agile/README.md)|[LFI](Boxes/linux/Retired/agile/README.md#lfi)|[Chrome Debug Mode](Boxes/linux/Retired/agile/README.md#chrome-debug-mode) AND [Sudoedit CVE-2023-22809](Boxes/linux/Retired/agile/README.md#sudoedit-cve-2023-22809)|
...
|<a href="https://app.hackthebox.eu/machines/Busqueda"><img width="25" hight="25" alt="busqueda" src="assets/busqueda.png"></a>|$\textcolor{green}{\textsf{Easy}}$|[Busqueda](Boxes/linux/Retired/busqueda/README.md)|[Command Injection](Boxes/linux/Retired/busqueda/README.md#command-injection)|[Docker inspect config dump](Boxes/linux/Retired/busqueda/README.md#docker-inspect-config-dump)|
...
|<a href="https://app.hackthebox.eu/machines/Inject"><img width="25" hight="25" alt="inject" src="assets/inject.png"></a>|$\textcolor{green}{\textsf{Easy}}$|[Inject](Boxes/linux/Retired/inject/README.md)|[Path Traversal in apache maven webApp](Boxes/linux/Retired/inject/README.md#path-traversal-in-apache-maven-webapp) AND [CVE-2022-22963](Boxes/linux/Retired/inject/README.md#cve-2022-22963)|[ansible-playbook](Boxes/linux/Retired/inject/README.md#ansible-playbook)|
...
|<a href="https://app.hackthebox.eu/machines/Mailroom"><img width="25" hight="25" alt="mailroom" src="assets/mailroom.png"></a>|$\textcolor{red}{\textsf{Hard}}$|[Mailroom](Boxes/linux/Retired/mailroom/README.md)|[Blind XSS](Boxes/linux/Retired/mailroom/README.md#blind-xss) AND [NoSQL injection](Boxes/linux/Retired/mailroom/README.md#nosql-injection) AND [Command Injection](Boxes/linux/Retired/mailroom/README.md#command-injection)|[Watch feature process and strace](Boxes/linux/Retired/mailroom/README.md#watch-feature-process-and-strace) AND [Open keepass database](Boxes/linux/Retired/mailroom/README.md#open-keepass-database)|
...
|<a href="https://app.hackthebox.eu/machines/MonitorsTwo"><img width="25" hight="25" alt="monitorsTwo" src="assets/monitorsTwo.png"></a>|$\textcolor{green}{\textsf{Easy}}$|[MonitorsTwo](Boxes/linux/Retired/monitorsTwo/README.md)|[Cacti Unauthenticated RCE CVE-2022-46169](Boxes/linux/Retired/monitorsTwo/README.md#cacti-unauthenticated-rce-cve-2022-46169)|[Docker overlay FS](Boxes/linux/Retired/monitorsTwo/README.md#docker-overlay-fs)|
|<a href="https://app.hackthebox.eu/machines/Onlyforyou"><img width="25" hight="25" alt="onlyforyou" src="assets/onlyforyou.png"></a>|$\textcolor{orange}{\textsf{Medium}}$|[Onlyforyou](Boxes/linux/Retired/onlyforyou/README.md)|[Directory Traversal](Boxes/linux/Retired/onlyforyou/README.md#directory-traversal) AND [Command Injection](Boxes/linux/Retired/onlyforyou/README.md#command-injection) AND [neo4j Cypher Injection](Boxes/linux/Retired/onlyforyou/README.md#neo4j-cypher-injection)|[pip3 as root](Boxes/linux/Retired/onlyforyou/README.md#pip3-as-root)|
...
|<a href="https://app.hackthebox.eu/machines/Socket"><img width="25" hight="25" alt="socket" src="assets/socket.png"></a>|$\textcolor{orange}{\textsf{Medium}}$|[Socket](Boxes/linux/Retired/socket/README.md)|[Python byte-codes de-compile](Boxes/linux/Retired/socket/README.md#python-byte-codes-de-compile) AND [Websocket SQLi using SQLMAP](Boxes/linux/Retired/socket/README.md#websocket-sqli-using-sqlmap)|[pyInstaller file read](Boxes/linux/Retired/socket/README.md#pyinstaller-file-read)|
